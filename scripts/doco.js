...
var jXML;
var sourceRepositoryURL = "http://tweaks.github.io/Tweaks/Source/WebContent/";
jQuery.ajax({
    type: "GET",
...
function buildCode(title, id, embedCode) {
	...
	var scriptBlock = "<"+"script src=\""+sourceRepositoryURL+"jquery.js\" type=\"text/javascript\"></"+"script><br/>"+
