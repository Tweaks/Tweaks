...
jQuery(function($){
	...
	var enrolFlagged = jQuery("#pageList script.tweak_script").parents("div.details").find("a:contains(\"Mark\")").length > 0;
	...
	if (!enrolFlagged || jQuery("body.ineditmode").length > 0)
	{
	  ...
	  var enrolMessage = "Self Enrol in ("+comname+") Community Site</a></h3>You will need to self enrol in this community site in order to participate. Click Close after you have enrolled to return to this page.<br><br>";
	  $("#pageList").before("<div><h3><a href=\"#\" class=\"thickbox\">"+enrolMessage+"</div>");
