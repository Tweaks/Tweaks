...
jQuery(function($){$(".makeDeepLink").each(function() { var targetLink = jQuery(this).parents("li").find("a:first"); targetLink.attr("href", deepLink(targetLink.attr("href"))).attr("target", "_blank"); }) });