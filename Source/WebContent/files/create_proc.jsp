...
{
	parentId = bbPm.generateId(Content.DATA_TYPE,request.getParameter("content_id")); 
	BbList childList = new BbList();
	try
	{
		childList = cLoader.loadChildren(parentId);
